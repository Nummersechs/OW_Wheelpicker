...
_OCR_PRELOAD_WORKER_GUARD_ERRORS = (
    AttributeError,
    RuntimeError,
    TypeError,
    ValueError,
...
class OCRPreloadWorker(QtCore.QObject):
    ...
    def _trace_runtime(self, event: str, **payload) -> None:
        ...
        except _OCR_PRELOAD_WORKER_GUARD_ERRORS:
            pass
    ...
    def _terminate_subprocess(self, proc: subprocess.Popen[str] | None, *, where: str) -> None:
        ...
        try:
            proc.terminate()
        except _OCR_PRELOAD_WORKER_GUARD_ERRORS as exc:
    ...
    def run(self) -> None:
        ...
        script = (
            ...
            "from controller.ocr.pipeline import importer as ocr_import\n"
