TRANSLATIONS_EN = {
    ...
    "controls.open_count_label": "Open players:",
    "controls.open_count_tooltip": "Sets the total players drawn in Open mode (1-6, limited by active role wheels).",
    ...
    "ocr.loading_tooltip": "OCR is still loading. Please wait.",
    ...
    "ocr.progress_line_role": "Recognizing names for {role}.",
    "ocr.progress_line_all": "Recognizing names for all roles.",
    "ocr.progress_line_wait": "Please wait a moment...",
    ...
    "wheel.pairs_toggle": "Pairs",
    "wheel.pairs_toggle_short": "Pair",
    "wheel.pairs_toggle_tooltip": "Pairs: switch between single-name spins and pair spins.",
    "wheel.subroles_toggle": "Subroles",
    "wheel.subroles_toggle_short": "Sub",
    "wheel.subroles_hint_generic": "Sub roles: only create pairs when sub roles are set.",
    "wheel.subroles_hint_labels": "Sub roles: only allow {a} + {b} pairs.",
    ...
    "overlay.shutdown_title": "Closing application",
    "overlay.shutdown_line1": "The app is shutting down.",
    "overlay.shutdown_line2": "Please wait...",
